class Project < ApplicationRecord
    ...
    attachment :video, :styles => { :medium => { :geometry => "640x480", :format => 'mp4' }, :thumb => { :geometry => "160x120", :format => 'jpeg', :time => 10 } }, :processors => [:transcoder], :default_url => "http://static.vr3.io/vr3/img/main/projectmissing.png", :storage => :ftp, :path => "/public_html/static/vr3/img/projects/:client/:attachment/:style/:filename", :url => "http://static.vr3.io/vr3/img/projects/:client/:attachment/:style/:filename", :ftp_servers => [
            {
                :host => "ftp.vr3.io",
                :user => "admin@vr3.io",
                :password => "Admin123!--"
